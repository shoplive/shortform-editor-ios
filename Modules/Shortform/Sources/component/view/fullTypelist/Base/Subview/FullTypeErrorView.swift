//
//  FullTypeErrorView.swift
//  ShopLiveShortformSDK
//
//  Created by sangmin han on 9/12/23.
//
...
class FullTypeErrorView : UIView {
...
extension FullTypeErrorView {
    private func setLayout(){
        self.addSubview(backBtn)
        let stack = UIStackView(arrangedSubviews: [emptyIconView,errorLabel])
        stack.axis = .vertical
        stack.spacing = 5
