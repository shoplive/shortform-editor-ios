...
//
//  Created by sangmin han on 3/6/24.
...
extension ShopLiveShortform {
    public struct ReferenceByType : BaseResponsable, RawDataRepresantable {
        typealias Model = ShopLiveShortform.ReferenceByType
        ...
        public init(from decoder: Decoder) throws {
            ...
            let container: KeyedDecodingContainer<Model.CodingKeys> = try decoder.container(keyedBy: ShopLiveShortform.ReferenceByType.CodingKeys.self)
