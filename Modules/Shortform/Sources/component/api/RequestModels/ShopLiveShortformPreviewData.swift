...
public final class ShopLiveShortformPreviewData : ShopLiveShortformRelatedData {
    ...
    public init(shortsId: String? = nil, reference: String? = nil, productId: String? = nil, name: String? = nil, skus: [String]? = nil, url: String? = nil, tags: [String]? = nil, tagSearchOperator: ShopLiveTagSearchOperator? = nil, brands: [String]? = nil, shuffle: Bool? = nil, referrer: String? = nil, isMuted : Bool? =  nil,previewPosition : ShopLiveShortform.PreviewPosition? = nil, previewScale : CGFloat? = nil, previewEdgeInset : UIEdgeInsets? = nil, previewFloatingOffset : UIEdgeInsets? = nil, useCloseButton : Bool? = nil, enableSwipeOut : Bool? = nil) {
