...
//            return chatFont.findAvailableFont()
        ...
        private var chatInputLineHeightMultiple: CGFloat {
            chatInputFont.lineHeightMultiple_SL()
        }
        ...
        var chatInputPlaceholderText: NSAttributedString {
            NSAttributedString(string: "댓글 달기...", attributes: chatPlaceholderAttributes)
        }
    ...
    var isExpanded: Bool {
        self.chatTextView.numberOfLines_SL() > 1
    }
    ...
    func textViewDidChange(_ textView: UITextView) {
        let numberOfLines: Int = textView.numberOfLines_SL()
...
final class ShopLiveChattingView: UITextView {
    ...
    private func setupShopLiveChattingView() {
        ...
        self.placeholderLabel.fitToSuperView_SL()
    }
