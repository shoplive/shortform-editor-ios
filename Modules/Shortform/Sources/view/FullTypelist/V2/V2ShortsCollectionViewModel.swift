...
extension V2ShortsCollectionViewModel {
    override func postActivePageNotification(srn: String?, index: Int) {
        NotificationCenter.default.post(Notification(name: Notification.Name("activePage"), object: nil, userInfo: ["srn": srn, "index": index, "shortsList" : shortsListData]))
    }
}
extension V2ShortsCollectionViewModel {
