...
extension ShopLiveShortform {
    class ShopLiveBridgeInterface: NSObject, WKScriptMessageHandler, ShopLiveBridgeInterfaceHandlerDelegate {
        ...
        private func setupObserver() {
            ...
            NotificationCenter.default.addObserver(self, selector: #selector(handleNotification(_:)), name: NSNotification.Name("showShortsDetail"), object: nil)
            NotificationCenter.default.addObserver(self, selector: #selector(handleNotification(_:)), name: NSNotification.Name("closeShortsDetail"), object: nil)
        ...
        private func teardownObserver() {
            ...
            NotificationCenter.default.removeObserver(self, name: NSNotification.Name("showShortsDetail"), object: nil)
            NotificationCenter.default.removeObserver(self, name: NSNotification.Name("closeShortsDetail"), object: nil)
        ...
        @objc func handleNotification(_ notification: Notification) {
            ...
            case Notification.Name("moveToProductBannerPage"):
                ...
                self.sendShortsEvent(event: "ON_CHANGED_SHORTFORM_DETAIL_PLAYER_SHOWN", parameter: ["isShown": false, "srn" : srn]) {}
                break
            case Notification.Name("closeShortsDetail"):
                var payLoad : [String : Any] = ["isShown": false ]
                if let srn = notification.userInfo?["srn"] as? String {
                    payLoad["srn"] = srn
                }
                self.sendShortsEvent(event: "ON_CHANGED_SHORTFORM_DETAIL_PLAYER_SHOWN", parameter: payLoad ) {}
                break
            case Notification.Name("showShortsDetail"):
