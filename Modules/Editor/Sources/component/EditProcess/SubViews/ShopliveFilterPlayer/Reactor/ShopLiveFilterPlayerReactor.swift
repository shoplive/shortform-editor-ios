...
class ShopLiveFilterPlayerReactor : NSObject, SLReactor {
    ...
    func action(_ action: Action) {
        ...
        case .setIsCenterCrop(let centerCrop):
    ...
    private func onSetUpFilterPlayer() {
        ...
        mainQueueResultHandler?( .setCropViewHidden(self.isCropMode ? false : true) )
...
extension ShopLiveFilterPlayerReactor {
    ...
    func getIsCenterCrop() -> Bool {
        return self.isCenterCrop
    }
