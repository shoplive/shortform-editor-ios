//
//  SLTimeTrimRightHandleView.swift
...
class SLTimeTrimRightHandleView : UIView {
    ...
    override func layoutSubviews() {
        ...
        backgroundView.roundCorners_SL(corners: [.topRight,.bottomRight], radius: cornerRadius)
...
extension SLTimeTrimRightHandleView {
