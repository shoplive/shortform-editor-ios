...
class SLVideoCropViewController : UIViewController {
    ...
    private var pageTitle : UILabel = {
        ...
        label.text = ShopLiveShortformEditorSDKStrings.Editor.Title.Crop.shoplive
        return label
    }()
    ...
    lazy private var confirmBtn : UIButton = {
        ...
        btn.setTitle(ShopLiveShortformEditorSDKStrings.Editor.Crop.Btn.Confirm.shoplive, for: .normal)
...
extension SLVideoCropViewController {
    ...
    private func onReactorSetShortsVideo(video : ShortsVideo) {
        ...
        self.playerView.action( .setUpFilterPlayer(fileName, videoUrl , videoSize,centerCrop: false, isCropMode: true, isCropAvailable: true, mode: .videoEditing) )
    }
