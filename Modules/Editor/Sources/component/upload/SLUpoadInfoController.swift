...
//        let view = UIImageView(image: ShopLiveShortformEditorSDKAsset.slPlaypreview.image.withRenderingMode(.alwaysOriginal))
//        view.translatesAutoresizingMaskIntoConstraints = false
...
//        let backButton = UIBarButtonItem(image: ShopLiveShortformEditorSDKAsset.slBackArrow.image.withRenderingMode(.alwaysTemplate), style: .plain, target: self, action: #selector(self.back))
//        
