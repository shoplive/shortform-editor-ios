...
public enum ShopLiveShortformEditorSDKAsset: Sendable {
  ...
  public static let slIcPause = ShopLiveShortformEditorSDKImages(name: "sl_ic_pause")
...
public struct ShopLiveShortformEditorSDKImages: Sendable {
