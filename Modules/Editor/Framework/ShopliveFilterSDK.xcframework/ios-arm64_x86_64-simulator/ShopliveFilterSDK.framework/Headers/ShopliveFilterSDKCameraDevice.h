/*
 * ShopliveFilterSDKCameraDevice.h
 *
...
// 本文件(ShopliveFilterSDKVideoCamera.h) 部分代码参考自: https://github.com/BradLarson/GPUImage/blob/master/framework/Source/GPUImageVideoCamera.h
// 对外接口， 添加较多中文注释

#ifndef ShopliveFilterSDK_ShopliveFilterSDKCamera_h
#define ShopliveFilterSDK_ShopliveFilterSDKCamera_h
...
@protocol ShopliveFilterSDKCameraDeviceOutputDelegate <NSObject>
...
@interface ShopliveFilterSDKCameraDevice : NSObject<AVCaptureVideoDataOutputSampleBufferDelegate,
                                    AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    __unsafe_unretained id<ShopliveFilterSDKCameraDeviceOutputDelegate> _outputDelegate;
}
...
- (id)delegate;
- (void)setDelegate: (id<ShopliveFilterSDKCameraDeviceOutputDelegate>)delegate;
