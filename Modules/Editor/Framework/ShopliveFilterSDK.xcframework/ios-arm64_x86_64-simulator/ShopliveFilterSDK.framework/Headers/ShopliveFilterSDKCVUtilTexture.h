/*
 * ShopliveFilterSDKCVUtilTexture.h
 *
...
@interface ShopliveFilterSDKCVUtilTexture : NSObject
...
typedef struct ShopliveFilterSDKCVBufferData
{
    void* data;
    int width, height;
...
}ShopliveFilterSDKCVBufferData;

@interface ShopliveFilterSDKCVUtilTextureWithFramebuffer : ShopliveFilterSDKCVUtilTexture
...
- (ShopliveFilterSDKCVBufferData)mapBuffer:(CVPixelBufferLockFlags)lockFlag;
