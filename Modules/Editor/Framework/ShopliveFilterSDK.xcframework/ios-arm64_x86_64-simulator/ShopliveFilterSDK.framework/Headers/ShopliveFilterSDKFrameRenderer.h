/*
 * ShopliveFilterSDKFrameRenderer.h
 *
...
#define ShopliveFilterSDK_FRAMERENDERER_VIDEOHANDLER_TYPE ShopliveFilterSDKVideoHandlerCV

@protocol ShopliveFilterSDKFrameUpdateDelegate <NSObject>
...
@protocol ShopliveFilterSDKFrameProcessingDelegate <NSObject>
...
- (void)setSharedContext:(ShopliveFilterSDKSharedGLContext*)context;
...
@protocol ShopliveFilterSDKFrameExtraRenderingDelegate <NSObject>
...
@interface ShopliveFilterSDKFrameRenderer : NSObject
