...
#if !defined(_ShopliveFilterSDKSPRITE2D_H_) && !defined(_ShopliveFilterSDK_ONLY_FILTERS_)
#define _ShopliveFilterSDKSPRITE2D_H_

#include "ShopliveFilterSDKSpriteCommon.h"

#define ShopliveFilterSDK_SPECIAL_SPRITE_CREATE_FUNC(cls, funcName)\
...
namespace ShopliveFilterSDK
{
	...
	public:
		...
		inline const ShopliveFilterSDK::Vec2f& getPosition() const { return m_pos; }
		inline const ShopliveFilterSDK::Vec2f& getScaling() const { return m_scaling; }
		inline const ShopliveFilterSDK::Vec2f& getHotspot() const { return m_hotspot; }
	...
	protected:
		static ShopliveFilterSDKConstString paramAttribPositionName;
		static ShopliveFilterSDKConstString paramProjectionMatrixName;
		static ShopliveFilterSDKConstString paramHalfTexSizeName;
		static ShopliveFilterSDKConstString paramRotationName;
		static ShopliveFilterSDKConstString paramScalingName;
		static ShopliveFilterSDKConstString paramTranslationName;
		static ShopliveFilterSDKConstString paramHotspotName;
		static ShopliveFilterSDKConstString paramAlphaName;
		static ShopliveFilterSDKConstString paramZIndexName;
		static ShopliveFilterSDKConstString paramTextureName;
		static ShopliveFilterSDKConstString paramFilpCanvasName;
		static ShopliveFilterSDKConstString paramFlipSpriteName;
		static ShopliveFilterSDKConstString paramBlendColorName;

	protected:
		ShopliveFilterSDK::Vec2f m_pos; //Sprite2d 的位置
		ShopliveFilterSDK::Vec2f m_scaling; //Sprite2d 的缩放
		ShopliveFilterSDK::Vec2f m_hotspot; //Sprite2d 的重心位置(乘以sprite本身尺寸的相对位置)
	...
	public:
		virtual ShopliveFilterSDKConstString getVertexString();
		virtual ShopliveFilterSDKConstString getFragmentString();
        
        ShopliveFilterSDK_COMMON_CREATE_FUNC_WITH_PARAM2(Sprite2d, _initProgram, const SharedTexture&);
	...
	public:
		ShopliveFilterSDKConstString getVertexString();
		ShopliveFilterSDKConstString getFragmentString();
		~Sprite2dWithAlphaGradient();
        
        ShopliveFilterSDK_COMMON_CREATE_FUNC_WITH_PARAM2(Sprite2dWithAlphaGradient, _initProgram, const SharedTexture&);
	...
	protected:
		...
		static ShopliveFilterSDKConstString paramAlphaFactorName;
		static ShopliveFilterSDKConstString paramTexAlphaName;
	...
	public:
        ...
        ShopliveFilterSDK_COMMON_CREATE_FUNC_WITH_PARAM2(Sprite2dInterChange, _initProgram, const SharedTexture&);
	...
	protected:
		static ShopliveFilterSDKConstString paramViewAreaName;
	...
	{
    protected:
        Sprite2dInterChangeExt(const SharedTexture& texture) : Sprite2dInterChange(texture), m_frameIndex(0), m_deltaTime(100.0f), m_deltaAccum(0.0f), m_lastTime(0.0f), m_blendMode(ShopliveFilterSDKGLOBAL_BLEND_NONE), m_shouldLoop(true) {}
	public:
		~Sprite2dInterChangeExt() {}

        ShopliveFilterSDK_COMMON_CREATE_FUNC_WITH_PARAM2(Sprite2dInterChangeExt, _initProgram, const SharedTexture&);
		...
		void setBlendMode(ShopliveFilterSDKGlobalBlendMode blendMode) { m_blendMode = blendMode; }
	...
	protected:
		...
		ShopliveFilterSDKGlobalBlendMode m_blendMode;
		bool m_shouldLoop;
	};
    ...
    public:
        ...
        ShopliveFilterSDK_SPECIAL_SPRITE_CREATE_FUNC(Sprite2dInterChangeMultiple, _initProgram);
...
//        void _drawFunc();
    ...
    public:
        ...
        ShopliveFilterSDK_SPECIAL_SPRITE_CREATE_FUNC(Sprite2dSequence, _initProgram);
