...
#if !defined(_ShopliveFilterSDKANIMATION_H_) && !defined(_ShopliveFilterSDK_ONLY_FILTERS_)
#define _ShopliveFilterSDKANIMATION_H_
...
namespace ShopliveFilterSDK
{
	...
	public:
		...
		void pushAction(RealActionType* action)
		{
			...
			ShopliveFilterSDKAssert(anim != nullptr);
		...
		{
			ShopliveFilterSDK_LOG_ERROR("Logic should not be added as child sprite!\n");
		}
	...
	public:
		...
		inline void pushChild(AnimationInterfaceType* child) { ShopliveFilterSDKAssert(child != this && child != nullptr); m_childAnimation.push_back(child); }		
	...
	public:
        ...
        ~TimeLineInterface() { ShopliveFilterSDK_LOG_INFO("Time line release...\n"); clear(); }
