/*
 * ShopliveFilterSDKDynamicImageViewHandler.h
 *
...
#import "ShopliveFilterSDKImageViewHandler.h"

//不适于图片帧特别多且图片分辨率较大的情况(当图片帧过多时将导致内存占用过多)

@interface ShopliveFilterSDKDynamicImageViewHandler : ShopliveFilterSDKImageViewHandler
