/*
 * ShopliveFilterSDKVideoCameraViewHandler.h
 *
 *  Created on: 2015-9-6
 *      Author: Wang Yang
...
#import "ShopliveFilterSDKCameraFrameRecorder.h"

@interface ShopliveFilterSDKCameraViewHandler : NSObject<ShopliveFilterSDKFrameUpdateDelegate>

@property(nonatomic, readonly) ShopliveFilterSDKCameraFrameRecorder* cameraRecorder;
...
- (ShopliveFilterSDKCameraDevice*) cameraDevice;
...
- (void)startRecording :(NSURL*)videoURL size:(CGSize)videoSize cropArea:(CGRect)cropArea; //cropArea参见ShopliveFilterSDKVideoWriter相关解释
