//
//  ShopLiveLoggerViewController.swift
//  ShopLiveSDKCommon
//
...
public final class ShopLiveViewLogger {
    ...
    public static var shared: ShopLiveViewLogger = {
        return ShopLiveViewLogger()
    }()

    public func setVisible(show: Bool) {
    ...
    public func addLog(log: ShopLiveViewLog) {
...
public final class ShopLiveViewLog {
    public enum LogType {
        case callback
        case interface
        case applog
    ...
    public init(logType: LogType, log: String) {
...
//            filterLogs()
    ...
    private lazy var onOffCallBack: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.alpha = 0.8
        button.setBackgroundColor_SL(.lightGray, for: .normal)
        button.setBackgroundColor_SL(.darkGray, for: .selected)
    ...
    private lazy var onOffHidden: UIButton = {
        ...
        button.alpha = 0.8
        button.setBackgroundColor_SL(.lightGray, for: .normal)
        button.setBackgroundColor_SL(.lightGray, for: .selected)
        button.titleLabel?.font = .boldSystemFont(ofSize: 16)
        button.addTarget(self, action: #selector(didTapOnOffButton(_:)), for: .touchUpInside)
    ...
    private func setupViews() {
        ...
        self.view.addSubviews_SL(onOffButton, onOffCallBack, onOffSendInterface, onOffAppLog, onOffHidden, onOffScroll, exportButton, clearButton)
...
extension ShopLiveViewLoggerController {
    ...
    private func removeObserver() {
        self.safeRemoveObserver_SL(self, forKeyPath: "isOn")
        self.safeRemoveObserver_SL(self, forKeyPath: "needReload")
    }
