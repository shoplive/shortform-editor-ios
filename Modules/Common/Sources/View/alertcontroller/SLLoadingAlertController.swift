...
@objc public protocol SLLoadingAlertControllerDelegate2: AnyObject {
    func didFinishLoading()
    func didTapBackground()
}

public class SLLoadingAlertController2: UIViewController, UIGestureRecognizerDelegate {

    public weak var delegate: SLLoadingAlertControllerDelegate2?
