...
class ShoplivePlayerEventTraceManager {
...
//        case pipClickClose = "PIP_CLICK_CLOSE"
    ...
    class func detailPlayerShow(campaignId : String?, shopliveSessionId : String?,  activityType : StreamActivityType) {
    ...
    class func detailPlayerDismiss(campaignId : String?, shopliveSessionId : String?,  activityType : StreamActivityType,streamEdgeType : String?) {
    ...
    class func previewShow(campaignId : String?, shopliveSessionId : String?,  activityType : StreamActivityType) {
    ...
    class func previewDismiss(campaignId : String?, shopliveSessionId : String?,  activityType : StreamActivityType,streamEdgeType : String?) {
    ...
    class func previewClickDetail(campaignId : String?, shopliveSessionId : String?, activityType : StreamActivityType,streamEdgeType : String?) {
    ...
    class func pipClickDetail(campaignId : String?, shopliveSessionId : String?, activityType : StreamActivityType,
    ...
    class func playerToPip(campaignId : String?, shopliveSessionId : String?, activityType : StreamActivityType,streamEdgeType : String?) {
    ...
    private class func callAPI(eventName : EventName, eventCategory : EventCategory, eventType : ShoplivePlayerEventTraceManager.EventType,
