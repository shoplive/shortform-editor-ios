...
class ShopLivePlayerEventTraceManagerImpl: NSObject, ShopLivePlayerEventTraceManager2 {
    ...
    func stateAction(_ action: ShopLivePlayerEventTraceStateAction) {
        switch action {
        case let .setCampaignId(campaignId):
            self.campaignId = campaignId
        case let .setShopLiveSessionId(id):
            self.shopLiveSessionId = id
        case let .setStreamActivityType(type):
            self.streamActivityType = type
        case let .setStreamEdgeType(type):
...
extension ShopLivePlayerEventTraceManagerImpl {
    ...
    private func sendDetailShow() {
        ShoplivePlayerEventTraceManager.detailPlayerShow(
    ...
    private func sendDetailDismiss() {
        ShoplivePlayerEventTraceManager.detailPlayerDismiss(
            campaignId: self.campaignId,
            shopliveSessionId: self.shopLiveSessionId,
            activityType: self.streamActivityType,
    ...
    private func sendPreviewShow() {
        ShoplivePlayerEventTraceManager.previewShow(
            campaignId: self.campaignId,
            shopliveSessionId: self.shopLiveSessionId,
            activityType: self.streamActivityType
        )
    ...
    private func sendPreviewDismiss() {
        ShoplivePlayerEventTraceManager.previewDismiss(
            campaignId: self.campaignId,
            shopliveSessionId: self.shopLiveSessionId,
            activityType: self.streamActivityType,
            streamEdgeType: self.streamEdgeType
    ...
    private func sendPreviewClickDetailEventTrace() {
        ShoplivePlayerEventTraceManager.previewClickDetail(
            campaignId: self.campaignId,
            shopliveSessionId: self.shopLiveSessionId,
            activityType: self.streamActivityType,
            streamEdgeType: self.streamEdgeType
    ...
    private func sendPlayerToPipMode() {
        ShoplivePlayerEventTraceManager.playerToPip(
            campaignId: self.campaignId,
            shopliveSessionId: self.shopLiveSessionId,
            activityType: self.streamActivityType,
            streamEdgeType: self.streamEdgeType
    ...
    private func sendPipToPlayerMode() {
        ShoplivePlayerEventTraceManager.pipToPlayer(
            campaignId: self.campaignId,
            shopliveSessionId: self.shopLiveSessionId,
            activityType: self.streamActivityType,
            streamEdgeType: self.streamEdgeType
...
extension ShopLivePlayerEventTraceManagerImpl {
    ...
    private func detailPlayerDismiss(
        campaignId: String?,
    ...
    private func previewClickDetail(
        campaignId: String?,
        shopliveSessionId: String?,
        activityType: StreamActivityType,
        streamEdgeType: String?
    ...
    private func callAPI(
        ...
        campaignId: String?,
        shopliveSessionId: String?,
        val1: Any?, val2: Any?, val3: Any?, val4: Any?, val5: Any?
    ){
