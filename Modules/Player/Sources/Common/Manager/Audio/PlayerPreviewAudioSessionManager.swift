//
//  PlayerPreviewAudioSessionManager.swift
//  ShopLiveSDK
//
...
final class PlayerPreviewAudioSessionManager: NSObject, SLReactor {
    static let shared = PlayerPreviewAudioSessionManager()
