...
final class PreviewRetryManager: NSObject, SLReactor {
    ...
    weak var delegate: PreviewRetryManagerDelegate?
    
    
    init(delegate: PreviewRetryManagerDelegate) {
