...
@objc public class ShopLivePlayerDataObjc : ShopLivePlayerData {
    ...
    @objc public init(campaignKey : String, keepWindowStateonPlayExecuted : Bool, referrer: String) {
        super.init(campaignKey: campaignKey,keepWindowStateOnPlayExecuted: keepWindowStateonPlayExecuted,referrer: referrer)
