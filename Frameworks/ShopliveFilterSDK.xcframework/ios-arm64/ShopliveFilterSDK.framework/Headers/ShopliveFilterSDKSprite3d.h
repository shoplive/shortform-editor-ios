...
#if! defined(_ShopliveFilterSDKSPRITE3d_H_) && !defined(_ShopliveFilterSDK_ONLY_FILTERS_)
#define _ShopliveFilterSDKSPRITE3d_H_
...
namespace ShopliveFilterSDK
{
    ...
    protected:
        virtual bool _initProgram(ShopliveFilterSDKConstString vsh, ShopliveFilterSDKConstString fsh);
	...
	{
// 	protected:
// 		Sprite3d(bool bInitProgram) : SpriteInterface3d() { ShopliveFilterSDKAssert(!bInitProgram); }
