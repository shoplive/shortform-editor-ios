/*
* ShopliveFilterSDKSlideshowSprite2dWith3dSpace.h
*
*  Created on: 2015-1-8
*      Author: Wang Yang
...
#ifndef _ShopliveFilterSDKSLIDESHOWSPRITE2DWITH3DSPACE_H_
#define _ShopliveFilterSDKSLIDESHOWSPRITE2DWITH3DSPACE_H_

#include "ShopliveFilterSDKSlideshow.h"
	...
	protected:
		virtual void _renderWithFather(TimeLineElem* father)
		{
			...
			else
			{
				...
				ShopliveFilterSDKAssert(f != nullptr); // 类型不兼容
			...
			ShopliveFilterSDK_LOG_CODE(
				...
				{
					ShopliveFilterSDK_LOG_ERROR("A children with children is not supported by now\n");
				}
				)
		}
