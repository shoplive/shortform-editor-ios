/*
 * ShopliveFilterSDKVideoPlayerViewHandler.h
 *
...
#import "ShopliveFilterSDKVideoPlayer.h"

typedef enum ShopliveFilterSDKVideoPlayerViewDisplayMode
{
    ShopliveFilterSDKVideoPlayerViewDisplayModeScaleToFill,
    ShopliveFilterSDKVideoPlayerViewDisplayModeAspectFill,
    ShopliveFilterSDKVideoPlayerViewDisplayModeAspectFit,
    ShopliveFilterSDKVideoPlayerViewDisplayModeDefault = ShopliveFilterSDKVideoPlayerViewDisplayModeScaleToFill
}ShopliveFilterSDKVideoPlayerViewDisplayMode;

@interface ShopliveFilterSDKVideoPlayerViewHandler : NSObject<ShopliveFilterSDKFrameUpdateDelegate>

@property(nonatomic) ShopliveFilterSDKVideoPlayer* videoPlayer;
...
@property(nonatomic, setter=setViewDisplayMode:) ShopliveFilterSDKVideoPlayerViewDisplayMode displayMode;
...
- (void)setViewDisplayMode :(ShopliveFilterSDKVideoPlayerViewDisplayMode)mode;
