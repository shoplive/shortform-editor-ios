/*
 * ShopliveFilterSDKCameraFrameRecorder.h
 *
...
#ifndef __ShopliveFilterSDK__ShopliveFilterSDKCameraFrameRecorder__
#define __ShopliveFilterSDK__ShopliveFilterSDKCameraFrameRecorder__

#import <Foundation/Foundation.h>
#import "ShopliveFilterSDKCameraDevice.h"
#import "ShopliveFilterSDKFrameRecorder.h"

@interface ShopliveFilterSDKCameraFrameRecorder : ShopliveFilterSDKFrameRecorder<ShopliveFilterSDKCameraDeviceOutputDelegate>

@property(nonatomic, weak, setter=setProcessingDelegate:) id<ShopliveFilterSDKFrameProcessingDelegate> processingDelegate;

@property(nonatomic, weak, setter=setExtraRenderingDelegate:) id<ShopliveFilterSDKFrameExtraRenderingDelegate> extraRenderingDelegate;

@property ShopliveFilterSDKCameraDevice* cameraDevice;
...
#endif /* defined(__ShopliveFilterSDK__ShopliveFilterSDKFrameRecorder__) */
