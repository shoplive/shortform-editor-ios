/*
* ShopliveFilterSDKCurveAdjust.h
*
*  Created on: 2014-1-2
*      Author: Wang Yang
*/

#ifndef _ShopliveFilterSDKCURVE_ADJUST_H_
#define _ShopliveFilterSDKCURVE_ADJUST_H_

#include "ShopliveFilterSDKGLFunctions.h"

namespace ShopliveFilterSDK
{
	class ShopliveFilterSDKCurveInterface
	{
		//It's a helper.
		//You should not make instances of this class.
	protected:
		ShopliveFilterSDKCurveInterface() {}
		virtual ~ShopliveFilterSDKCurveInterface() {}
	...
	public:
		...
		inline void resetCurve() { ShopliveFilterSDKCurveInterface::resetCurve(m_curve, ShopliveFilterSDK_CURVE_PRECISION); }
	...
	protected:
		...
		static void _assignCurveArrays(ProgramObject& program, ShopliveFilterSDKConstString name, std::vector<CurveData>& data);
		static void _assignCurveSampler(GLuint& texID, std::vector<CurveData>& data);
	};

	class ShopliveFilterSDKCurveTexFilter : public ShopliveFilterSDKImageFilterInterface, public ShopliveFilterSDKCurveInterface
	{
	public:
		ShopliveFilterSDKCurveTexFilter() : m_curveTexture(0){}
		virtual ~ShopliveFilterSDKCurveTexFilter(){glDeleteTextures(1, &m_curveTexture); m_curveTexture = 0;}
		bool init();
		//////////////////////////////////////////////////////////////////////////
	...
	class ShopliveFilterSDKCurveFilter  : public ShopliveFilterSDKImageFilterInterface, public ShopliveFilterSDKCurveInterface
	{
	public:
		ShopliveFilterSDKCurveFilter(){}
		~ShopliveFilterSDKCurveFilter() {}
	...
	//See more information in "BasicAdjusts::ShopliveFilterSDKCurveInterface"
	class ShopliveFilterSDKMoreCurveFilter : public ShopliveFilterSDKImageFilterInterface, public ShopliveFilterSDKCurveInterface
	{
	public:
		ShopliveFilterSDKMoreCurveFilter(){}
	...
	//为了结构层次清晰， 与ShopliveFilterSDKCurveTexFilter 存在部分相似代码
	class ShopliveFilterSDKMoreCurveTexFilter : public ShopliveFilterSDKMoreCurveFilter
	{
	public:
		ShopliveFilterSDKMoreCurveTexFilter() : m_curveTexture(0){}
		virtual ~ShopliveFilterSDKMoreCurveTexFilter(){glDeleteTextures(1, &m_curveTexture); m_curveTexture = 0;}
