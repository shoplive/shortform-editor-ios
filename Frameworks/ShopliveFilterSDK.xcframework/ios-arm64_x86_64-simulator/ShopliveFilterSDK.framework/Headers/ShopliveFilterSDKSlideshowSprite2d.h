/*
* ShopliveFilterSDKSlideshowSprite2d.h
*
*  Created on: 2015-1-8
*      Author: Wang Yang
...
#ifndef _ShopliveFilterSDKSLIDESHOWSPRITE2D_H_
#define _ShopliveFilterSDKSLIDESHOWSPRITE2D_H_
...
//        AnimationSpriteInterface2d(float start, float end) : FatherType(start, end) {}
	...
	protected:
		virtual void _renderWithFather(TimeLineElem* father)
		{
			...
			ShopliveFilterSDKAssert(f != nullptr);
