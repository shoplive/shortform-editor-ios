/*
 * ShopliveFilterSDKVideoWriter.h
 *
...
@interface ShopliveFilterSDKVideoWriter : NSObject
{
    NSURL* _fileURL;
    NSString* _fileType;
...
- (id)initWithMovieURL:(NSURL *)newMovieURL size:(CGSize)newSize fileType:(NSString *)newFileType outputSettings:(NSDictionary *)outputSettings usingContext:(ShopliveFilterSDKSharedGLContext*)context;
