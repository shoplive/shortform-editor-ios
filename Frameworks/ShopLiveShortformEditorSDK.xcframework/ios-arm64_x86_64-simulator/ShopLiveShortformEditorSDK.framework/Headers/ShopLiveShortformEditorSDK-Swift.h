...
- (void)onShopLiveCoverPickerUploadSuccessWithShortsId:(NSString * _Nonnull)shortsId;
...
- (void)onShopLiveShortformEditorUploadSuccessWithShortsId:(NSString * _Nonnull)shortsId;
...
- (void)onShopLiveVideoEditorUploadSuccessWithShortsId:(NSString * _Nonnull)shortsId;
