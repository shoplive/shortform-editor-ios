...
SWIFT_CLASS("_TtC26ShopLiveShortformEditorSDK14SLAlbumPopView")
...
SWIFT_CLASS("_TtC26ShopLiveShortformEditorSDK28SLAssetPreviewViewController")
...
SWIFT_CLASS("_TtC26ShopLiveShortformEditorSDK25SLCollectionTableViewCell")
...
SWIFT_CLASS("_TtC26ShopLiveShortformEditorSDK28SLPhotosPickerViewController")
...
@interface SLPhotosPickerViewController (SWIFT_EXTENSION(ShopLiveShortformEditorSDK)) <UINavigationBarDelegate>
...
@interface SLPhotosPickerViewController (SWIFT_EXTENSION(ShopLiveShortformEditorSDK)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
- (void)imagePickerControllerDidCancel:(UIImagePickerController * _Nonnull)picker;
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
@end


@interface SLPhotosPickerViewController (SWIFT_EXTENSION(ShopLiveShortformEditorSDK)) <UICollectionViewDataSource, UICollectionViewDataSourcePrefetching, UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC26ShopLiveShortformEditorSDK11VideoPlayer")
